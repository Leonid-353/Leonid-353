...
```text
🎯 Специализируюсь на создании микросервисных приложений. Проектировал архитектуру распределенных 
систем, настраивал взаимодействие сервисов через Kafka, применял Eureka и API Gateway, писал 
интеграционные тесты.

🌍 В профессии меня увлекает возможность проектировать сложные системы и видеть результат своей 
работы, а также постоянно изучать новые технологии. Мне важно работать в команде, где ценят 
качественный код, взаимопомощь и профессиональный рост.
...
[![Spring Cloud](https://img.shields.io/badge/Spring%20Cloud-black?style=for-the-badge&logo=spring)](https://spring.io/projects/spring-cloud)
[![Spring Security](https://img.shields.io/badge/Spring%20Security-black?style=for-the-badge&logo=spring)](https://spring.io/projects/spring-security)
[![Spring Data](https://img.shields.io/badge/Spring%20Data-black?style=for-the-badge&logo=spring)](https://spring.io/projects/spring-data)
[![Hibernate](https://img.shields.io/badge/Hibernate-black?style=for-the-badge&logo=hibernate&logoColor=59666C)](https://hibernate.org/)
